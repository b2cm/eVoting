...
export interface ZkSyncPaymasterInterface extends utils.Interface {
  functions: {
...
export interface ZkSyncPaymaster extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZkSyncPaymasterInterface;
