...
contract VerifierMembershipZKP {
    ...
    /**@notice This function verifies the ZKP of Membership. 
    * This ZKP checks whether the answer chosen by the voter is one of the options offered.
    */
    ...
    /**@notice Convert the given values to BigNumbers.
    *@param _values The values to convert to BN
    *@return _bg The given values as BigNumber
    */
