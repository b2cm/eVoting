    ...
    (Data_Show.show(Data_BigInt.showBigInt)(v.value0) +
      (" " +
        (Data_Show.show(Data_BigInt.showBigInt)(v.value1) +
          (" " +
            (Data_Show.show(Data_Show.showArray(Data_BigInt.showBigInt))(
              v.value2
            ) +
              ")")))))
  );
...
var hash = function (v) {
  return function (salt) {
    return function (bits) {
      var distinctHashes = Data_Functor.map(Data_Functor.functorArray)(
        function (x) {
      ...
      var hashed2560bits = Data_Foldable.foldr(Data_Foldable.foldableArray)(
        Data_Semigroup.append(Data_Semigroup.semigroupString)
      )("")(distinctHashes);
      var bigInt = Data_Maybe.fromMaybe(b0)(
        Data_BigInt.fromBase(16)(hashed2560bits)
      );
...
var hash2 = function (v) {
  return function (bits) {
    var h = Data_Semiring.add(Data_BigInt.semiringBigInt)(
      Data_Modular.mMod(hash(v)("salt3")(bits))(
        Data_Ring.sub(Data_BigInt.ringBigInt)(v.value1)(b2)
      )
    )(b2);
    return Data_Modular.mMod(
      Data_Semiring.mul(Data_BigInt.semiringBigInt)(h)(h)
    )(
      Data_Semiring.add(Data_BigInt.semiringBigInt)(
        Data_Semiring.mul(Data_BigInt.semiringBigInt)(b2)(v.value1)
      )(b1)
    );
  };
};
  ...
  return function (y) {
    return function (v1) {
      return function (m) {
        ...
        var h = hash2(v)(l);
        var b = Data_Modular.mMul(v.value2)(
          Data_Modular.mPow(v.value2)(h)(v1.value1)
        )(
          Data_Modular.mPow(v.value2)(v1.value0)(
            Data_Foldable.sum(Data_Foldable.foldableArray)(
              Data_BigInt.semiringBigInt
            )(v1.value2)
          )
        );
        var a = Data_Modular.mMul(v.value2)(
          Data_Modular.mPow(v.value2)(v.value0)(v1.value1)
        )(
          Data_Modular.mProd(v.value2)(
            Data_Array.zipWith(Data_Modular.mPow(v.value2))(y)(v1.value2)
          )
        );
        var h1 = hash1(v)(
          enc.Hex.parse(
            l + v1.value0.toString(16) + mS + a.toString(16) + b.toString(16)
          )
        );
        return Data_Eq.eq(Data_BigInt.eqBigInt)(
          Data_EuclideanRing.mod(Data_BigInt.euclideanRingBigInt)(
            Data_Foldable.sum(Data_Foldable.foldableArray)(
              Data_BigInt.semiringBigInt
            )(v1.value2)
          )(v.value1)
  ...
  return function (v) {
    return function (y) {
      return function (v1) {
        return function (m) {
          let mS = processMessage(m);
          var n = Data_Maybe.fromMaybe(0)(
            Data_Array.findIndex(function (v2) {
          ...
          var sc = Data_Foldable.sum(Data_Foldable.foldableArray)(
            Data_BigInt.semiringBigInt
          )(c);
          var b = Data_Modular.mMul(v.value2)(
            Data_Modular.mPow(v.value2)(h)(r)
          )(Data_Modular.mPow(v.value2)(y0)(sc));
          var a = Data_Modular.mMul(v.value2)(
            Data_Modular.mPow(v.value2)(v.value0)(r)
          )(
            Data_Modular.mProd(v.value2)(
              Data_Array.zipWith(Data_Modular.mPow(v.value2))(y)(c)
            )
          );
          var h1 = hash1(v)(
            enc.Hex.parse(
              l + y0.toString(16) + mS + a.toString(16) + b.toString(16)
            )
          );
          var ci = Data_Modular.mMod(
            Data_Ring.sub(Data_BigInt.ringBigInt)(h1)(sc)
          )(v.value1);
          var s = Data_Modular.mMod(
            Data_Ring.sub(Data_BigInt.ringBigInt)(r)(
              Data_Semiring.mul(Data_BigInt.semiringBigInt)(ci)(v1.value1)
            )
          )(v.value1);
          var sig = new Signature(
            y0,
            s,
            Data_Maybe.fromMaybe(c)(Data_Array.updateAt(n)(ci)(c))
          );
          return sig;
        };
      };
