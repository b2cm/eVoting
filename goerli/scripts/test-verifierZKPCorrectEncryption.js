...
const VERIFIER_MEMBERSHIPZKP_ABI = (require("../../client/src/contracts/goerli/artifacts/contracts/VerifierZKPCorrectEncryption.sol/VerifierZKPCorrectEncryption.json")).abi;
...
async function main() {
  ...
  for ( const [key, value] of Object.entries(data.values)) {
    const result = await verifier.callStatic.verifyTx(
        value.cipher,
        value.proof,
