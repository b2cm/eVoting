...
export default function NewVote(props) {
    ...
    const handleCreateNewVoteClick = useCallback(async() => {
        ...
        try {
            ...
            //alert('fee', ethers.utils.formatEther(fee));
            ...
            //alert ('tx', txHandle);
              ...
              events.forEach(e => {
                if(e.event === 'VotingCreated') {
                    ...
                    const message = 'Die Wahl wurde erfolgreich erstellt'
