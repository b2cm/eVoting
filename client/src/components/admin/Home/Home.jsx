...
import  RegisterPeriod  from '../../common/RegisterPeriod';
...
function Home() {
    ...
    const { l2Contracts, signer, l2Provider, accounts, artifacts, chainId, ethProvider, isAdminAuthenticated, openRegisterDialogBox} = state;
    const navigate = useNavigate();
    //console.log('open dialog', openRegisterDialogBox);
    ...
    useEffect(() => {
        const postData = async ( data = {}) => {
            ...
            const url = "http://localhost:3100/SessionData/537a3c79-e41c-4b54-a8df-0c2bf6cf1267";
            ...
            //console.log('session', await response.body.getReader().read());
