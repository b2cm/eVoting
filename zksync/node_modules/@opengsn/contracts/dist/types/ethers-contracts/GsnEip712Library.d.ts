...
export interface GsnEip712LibraryInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "EIP712DOMAIN_TYPEHASH" | "GENERIC_PARAMS" | "RELAYDATA_TYPE" | "RELAYDATA_TYPEHASH" | "RELAY_REQUEST_NAME" | "RELAY_REQUEST_SUFFIX" | "RELAY_REQUEST_TYPE" | "RELAY_REQUEST_TYPEHASH"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "RELAYDATA_TYPE", values?: undefined): string;
    encodeFunctionData(functionFragment: "RELAYDATA_TYPEHASH", values?: undefined): string;
    encodeFunctionData(functionFragment: "RELAY_REQUEST_NAME", values?: undefined): string;
    encodeFunctionData(functionFragment: "RELAY_REQUEST_SUFFIX", values?: undefined): string;
    encodeFunctionData(functionFragment: "RELAY_REQUEST_TYPE", values?: undefined): string;
    encodeFunctionData(functionFragment: "RELAY_REQUEST_TYPEHASH", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "RELAYDATA_TYPE", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "RELAYDATA_TYPEHASH", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "RELAY_REQUEST_NAME", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "RELAY_REQUEST_SUFFIX", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "RELAY_REQUEST_TYPE", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "RELAY_REQUEST_TYPEHASH", data: BytesLike): Result;
    events: {};
}
export interface GsnEip712Library extends BaseContract {
    ...
    populateTransaction: {
        EIP712DOMAIN_TYPEHASH(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        RELAYDATA_TYPEHASH(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        RELAY_REQUEST_NAME(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        RELAY_REQUEST_SUFFIX(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        RELAY_REQUEST_TYPE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        RELAY_REQUEST_TYPEHASH(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
