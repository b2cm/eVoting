...
export interface TestPaymasterOwnerSignatureInterface extends utils.Interface {
    functions: {
...
export interface TestPaymasterOwnerSignature extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestPaymasterOwnerSignatureInterface;
