...
export interface TestPaymasterVariableGasLimitsInterface extends utils.Interface {
    functions: {
    ...
    events: {
        ...
        "SampleRecipientPostCallWithValues(uint256,uint256)": EventFragment;
        "SampleRecipientPreCall()": EventFragment;
        "SampleRecipientPreCallWithValues(uint256,uint256)": EventFragment;
    };
...
export interface TestPaymasterVariableGasLimits extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestPaymasterVariableGasLimitsInterface;
    ...
    filters: {
        ...
        "SampleRecipientPostCallWithValues(uint256,uint256)"(gasleft?: null, gasUseWithoutPost?: null): SampleRecipientPostCallWithValuesEventFilter;
        SampleRecipientPostCallWithValues(gasleft?: null, gasUseWithoutPost?: null): SampleRecipientPostCallWithValuesEventFilter;
        "SampleRecipientPreCall()"(): SampleRecipientPreCallEventFilter;
        SampleRecipientPreCall(): SampleRecipientPreCallEventFilter;
        "SampleRecipientPreCallWithValues(uint256,uint256)"(gasleft?: null, maxPossibleGas?: null): SampleRecipientPreCallWithValuesEventFilter;
        SampleRecipientPreCallWithValues(gasleft?: null, maxPossibleGas?: null): SampleRecipientPreCallWithValuesEventFilter;
    };
    estimateGas: {
        CALLDATA_SIZE_LIMIT(overrides?: CallOverrides): Promise<BigNumber>;
        FORWARDER_HUB_OVERHEAD(overrides?: CallOverrides): Promise<BigNumber>;
