...
export interface TestForwarderTargetInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getTrustedForwarder" | "isTrustedForwarder" | "emitMessage" | "publicMsgSender" | "publicMsgData" | "mustReceiveEth" | "testRevert"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "publicMsgSender", values?: undefined): string;
    encodeFunctionData(functionFragment: "publicMsgData", values?: undefined): string;
    encodeFunctionData(functionFragment: "mustReceiveEth", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "publicMsgSender", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "publicMsgData", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "mustReceiveEth", data: BytesLike): Result;
...
export type TestForwarderMessageEventFilter = TypedEventFilter<TestForwarderMessageEvent>;
export interface TestForwarderTarget extends BaseContract {
    ...
    callStatic: {
        ...
        publicMsgSender(overrides?: CallOverrides): Promise<string>;
        publicMsgData(overrides?: CallOverrides): Promise<string>;
        mustReceiveEth(value: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "TestForwarderMessage(string,bytes,address,address,address)"(message?: null, realMsgData?: null, realSender?: null, msgSender?: null, origin?: null): TestForwarderMessageEventFilter;
        TestForwarderMessage(message?: null, realMsgData?: null, realSender?: null, msgSender?: null, origin?: null): TestForwarderMessageEventFilter;
    };
    estimateGas: {
        /**
         * :warning: **Warning** :warning: The Forwarder can have a full control over your Recipient. Only trust verified Forwarder.Method is not a required method to allow Recipients to trust multiple Forwarders. Not recommended yet.
