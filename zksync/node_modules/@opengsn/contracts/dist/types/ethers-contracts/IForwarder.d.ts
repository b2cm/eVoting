...
export interface IForwarderInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "supportsInterface" | "getNonce" | "verify" | "execute" | "registerRequestType" | "registerDomainSeparator"): FunctionFragment;
...
export interface IForwarder extends BaseContract {
    ...
    functions: {
        ...
        verify(forwardRequest: IForwarder.ForwardRequestStruct, domainSeparator: BytesLike, requestTypeHash: BytesLike, suffixData: BytesLike, signature: BytesLike, overrides?: CallOverrides): Promise<[void]>;
        execute(forwardRequest: IForwarder.ForwardRequestStruct, domainSeparator: BytesLike, requestTypeHash: BytesLike, suffixData: BytesLike, signature: BytesLike, overrides?: PayableOverrides & {
            from?: string;
    ...
    callStatic: {
        ...
        getNonce(from: string, overrides?: CallOverrides): Promise<BigNumber>;
        verify(forwardRequest: IForwarder.ForwardRequestStruct, domainSeparator: BytesLike, requestTypeHash: BytesLike, suffixData: BytesLike, signature: BytesLike, overrides?: CallOverrides): Promise<void>;
        execute(forwardRequest: IForwarder.ForwardRequestStruct, domainSeparator: BytesLike, requestTypeHash: BytesLike, suffixData: BytesLike, signature: BytesLike, overrides?: CallOverrides): Promise<[boolean, string] & {
            success: boolean;
            ret: string;
        }>;
        /**
    ...
    estimateGas: {
         ...
         */
        getNonce(from: string, overrides?: CallOverrides): Promise<BigNumber>;
        verify(forwardRequest: IForwarder.ForwardRequestStruct, domainSeparator: BytesLike, requestTypeHash: BytesLike, suffixData: BytesLike, signature: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        execute(forwardRequest: IForwarder.ForwardRequestStruct, domainSeparator: BytesLike, requestTypeHash: BytesLike, suffixData: BytesLike, signature: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<BigNumber>;
        /**
    ...
    populateTransaction: {
        ...
        verify(forwardRequest: IForwarder.ForwardRequestStruct, domainSeparator: BytesLike, requestTypeHash: BytesLike, suffixData: BytesLike, signature: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        execute(forwardRequest: IForwarder.ForwardRequestStruct, domainSeparator: BytesLike, requestTypeHash: BytesLike, suffixData: BytesLike, signature: BytesLike, overrides?: PayableOverrides & {
            from?: string;
