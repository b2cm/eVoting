...
export interface TestRecipientWithoutFallbackInterface extends utils.Interface {
    functions: {
...
export interface TestRecipientWithoutFallback extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestRecipientWithoutFallbackInterface;
