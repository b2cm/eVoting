...
export interface TestPaymasterStoreContextInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "CALLDATA_SIZE_LIMIT" | "FORWARDER_HUB_OVERHEAD" | "PAYMASTER_ACCEPTANCE_BUDGET" | "POST_RELAYED_CALL_GAS_LIMIT" | "PRE_RELAYED_CALL_GAS_LIMIT" | "deposit" | "getGasAndDataLimits" | "getRelayHub" | "getTrustedForwarder" | "owner" | "postRelayedCall" | "preRelayedCall" | "renounceOwnership" | "setRelayHub" | "setTrustedForwarder" | "supportsInterface" | "transferOwnership" | "versionPaymaster" | "withdrawAll" | "withdrawRelayHubDepositTo"): FunctionFragment;
    ...
    events: {
        ...
        "SampleRecipientPostCallWithValues(string)": EventFragment;
        "SampleRecipientPreCall()": EventFragment;
        "SampleRecipientPreCallWithValues(address,address,bytes,uint256,uint256,bytes,uint256)": EventFragment;
    };
    getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "SampleRecipientPostCall"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "SampleRecipientPostCallWithValues"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "SampleRecipientPreCall"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "SampleRecipientPreCallWithValues"): EventFragment;
}
...
export interface SampleRecipientPostCallWithValuesEventObject {
    context: string;
}
export type SampleRecipientPostCallWithValuesEvent = TypedEvent<[
    string
], SampleRecipientPostCallWithValuesEventObject>;
export type SampleRecipientPostCallWithValuesEventFilter = TypedEventFilter<SampleRecipientPostCallWithValuesEvent>;
...
export interface SampleRecipientPreCallWithValuesEventObject {
    relay: string;
    from: string;
...
export type SampleRecipientPreCallWithValuesEvent = TypedEvent<[
    string,
    string,
    string,
    BigNumber,
    ...
    string,
    BigNumber
], SampleRecipientPreCallWithValuesEventObject>;
export type SampleRecipientPreCallWithValuesEventFilter = TypedEventFilter<SampleRecipientPreCallWithValuesEvent>;
export interface TestPaymasterStoreContext extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestPaymasterStoreContextInterface;
    ...
    filters: {
        ...
        "SampleRecipientPostCallWithValues(string)"(context?: null): SampleRecipientPostCallWithValuesEventFilter;
        SampleRecipientPostCallWithValues(context?: null): SampleRecipientPostCallWithValuesEventFilter;
        "SampleRecipientPreCall()"(): SampleRecipientPreCallEventFilter;
        SampleRecipientPreCall(): SampleRecipientPreCallEventFilter;
        "SampleRecipientPreCallWithValues(address,address,bytes,uint256,uint256,bytes,uint256)"(relay?: null, from?: null, encodedFunction?: null, baseRelayFee?: null, gasLimit?: null, approvalData?: null, maxPossibleGas?: null): SampleRecipientPreCallWithValuesEventFilter;
        SampleRecipientPreCallWithValues(relay?: null, from?: null, encodedFunction?: null, baseRelayFee?: null, gasLimit?: null, approvalData?: null, maxPossibleGas?: null): SampleRecipientPreCallWithValuesEventFilter;
    };
    estimateGas: {
        CALLDATA_SIZE_LIMIT(overrides?: CallOverrides): Promise<BigNumber>;
        FORWARDER_HUB_OVERHEAD(overrides?: CallOverrides): Promise<BigNumber>;
