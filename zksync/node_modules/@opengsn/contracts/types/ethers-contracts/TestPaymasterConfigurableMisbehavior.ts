...
export interface TestPaymasterConfigurableMisbehaviorInterface
  ...
  encodeFunctionData(
    functionFragment: "expensiveGasLimits",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "greedyAcceptanceBudget",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "outOfGasPre",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "returnInvalidErrorCode",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "revertPostRelayCall",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "revertPreRelayCall",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "revertPreRelayCallOnEvenBlocks",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "withdrawDuringPostRelayedCall",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "withdrawDuringPreRelayedCall",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setWithdrawDuringPostRelayedCall",
    values: [boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "setWithdrawDuringPreRelayedCall",
    values: [boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "setReturnInvalidErrorCode",
    values: [boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "setRevertPostRelayCall",
    values: [boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "setRevertPreRelayCall",
    values: [boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "setRevertPreRelayCallOnEvenBlocks",
    values: [boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "setOutOfGasPre",
    values: [boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "setGreedyAcceptanceBudget",
    values: [boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "setExpensiveGasLimits",
    values: [boolean]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setTrustRecipientRevert",
    values: [boolean]
  ): string;
