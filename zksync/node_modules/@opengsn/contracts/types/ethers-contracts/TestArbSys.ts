...
export interface TestArbSysInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "arbBlockNumber" | "getStorageGasAvailable"
  ): FunctionFragment;
...
export interface TestArbSys extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestArbSysInterface;
