...
export interface TestRelayHubValidatorInterface extends utils.Interface {
  functions: {
    "dummyRelayCall(string,uint256,((address,address,uint256,uint256,uint256,bytes,uint256),(uint256,uint256,uint256,address,address,address,bytes,uint256)),bytes,bytes)": FunctionFragment;
    "dynamicParamSize(bytes)": FunctionFragment;
  };

  getFunction(
    nameOrSignatureOrTopic: "dummyRelayCall" | "dynamicParamSize"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "dummyRelayCall",
    values: [
      string,
      BigNumberish,
  ...
  encodeFunctionData(
    functionFragment: "dynamicParamSize",
    values: [BytesLike]
  ): string;
...
export interface TestRelayHubValidator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestRelayHubValidatorInterface;
