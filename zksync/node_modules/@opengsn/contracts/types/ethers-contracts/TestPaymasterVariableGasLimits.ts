...
export interface TestPaymasterVariableGasLimitsInterface
...
export interface TestPaymasterVariableGasLimits extends BaseContract {
  ...
  filters: {
    ...
    "SampleRecipientPostCallWithValues(uint256,uint256)"(
      gasleft?: null,
    ...
    "SampleRecipientPreCallWithValues(uint256,uint256)"(
      gasleft?: null,
      maxPossibleGas?: null
