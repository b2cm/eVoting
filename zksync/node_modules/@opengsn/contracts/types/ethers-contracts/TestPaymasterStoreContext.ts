...
export interface TestPaymasterStoreContextInterface extends utils.Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "SampleRecipientPostCallWithValues"
  ): EventFragment;
  getEvent(nameOrSignatureOrTopic: "SampleRecipientPreCall"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "SampleRecipientPreCallWithValues"
  ): EventFragment;
}
...
export type SampleRecipientPostCallEventFilter =
  TypedEventFilter<SampleRecipientPostCallEvent>;
...
export type SampleRecipientPostCallWithValuesEventFilter =
  TypedEventFilter<SampleRecipientPostCallWithValuesEvent>;
...
export type SampleRecipientPreCallEventFilter =
  TypedEventFilter<SampleRecipientPreCallEvent>;
...
export type SampleRecipientPreCallWithValuesEventFilter =
  TypedEventFilter<SampleRecipientPreCallWithValuesEvent>;
...
export interface TestPaymasterStoreContext extends BaseContract {
  ...
  filters: {
    ...
    "SampleRecipientPostCall(bool,uint256)"(
      success?: null,
      actualCharge?: null
    ): SampleRecipientPostCallEventFilter;
    SampleRecipientPostCall(
      success?: null,
      actualCharge?: null
    ): SampleRecipientPostCallEventFilter;

    "SampleRecipientPostCallWithValues(string)"(
      context?: null
    ): SampleRecipientPostCallWithValuesEventFilter;
    ...
    "SampleRecipientPreCallWithValues(address,address,bytes,uint256,uint256,bytes,uint256)"(
      relay?: null,
      from?: null,
      ...
      approvalData?: null,
      maxPossibleGas?: null
    ): SampleRecipientPreCallWithValuesEventFilter;
