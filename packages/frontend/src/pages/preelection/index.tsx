...
export default function Electionres() {
  ...
  const [lookupTableHash, setLookupTableHash] = useState("");
  ...
  useEffect(() => {
    ...
    const cb2 = async () => {
      ...
      setLookupTableHash(await GetLookUpTableHash());
    };
  ...
  return (
    <div>
                        ...
                        (item: {
                          ...
                          return (
                            <>
                              ...
                              <div> Party:{item.partyId} </div> <br></br>
                            </>
                          );
                        }
                      )}
      ...
      {lookupTableHash && (
        <>
          <div>Lookup table hash</div>
          <span>{lookupTableHash}</span>
        </>
      )}
