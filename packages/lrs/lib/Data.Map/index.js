...
var values = function (v) {
  ...
  if (v instanceof Two) {
    return Data_Semigroup.append(Data_List.semigroupList)(values(v.value0))(
      Data_Semigroup.append(Data_List.semigroupList)(
        Control_Applicative.pure(Data_List.applicativeList)(v.value2)
      )(values(v.value3))
    );
  }
  if (v instanceof Three) {
    return Data_Semigroup.append(Data_List.semigroupList)(values(v.value0))(
      Data_Semigroup.append(Data_List.semigroupList)(
        ...
        Data_Semigroup.append(Data_List.semigroupList)(values(v.value3))(
          Data_Semigroup.append(Data_List.semigroupList)(
            Control_Applicative.pure(Data_List.applicativeList)(v.value5)
          )(values(v.value6))
        )
      )
    );
  ...
  throw new Error(
    "Failed pattern match at Data.Map line 391, column 1 - line 391, column 18: " +
      [v.constructor.name]
  );
};
var toList = function (v) {
  ...
  if (v instanceof Two) {
    return Data_Semigroup.append(Data_List.semigroupList)(toList(v.value0))(
      Data_Semigroup.append(Data_List.semigroupList)(
        Control_Applicative.pure(Data_List.applicativeList)(
          new Data_Tuple.Tuple(v.value1, v.value2)
        )
      )(toList(v.value3))
    );
  }
  if (v instanceof Three) {
    return Data_Semigroup.append(Data_List.semigroupList)(toList(v.value0))(
      Data_Semigroup.append(Data_List.semigroupList)(
        ...
        Data_Semigroup.append(Data_List.semigroupList)(toList(v.value3))(
          Data_Semigroup.append(Data_List.semigroupList)(
            Control_Applicative.pure(Data_List.applicativeList)(
              new Data_Tuple.Tuple(v.value4, v.value5)
            )
          )(toList(v.value6))
        )
      )
  ...
  throw new Error(
    "Failed pattern match at Data.Map line 370, column 1 - line 370, column 18: " +
      [v.constructor.name]
  );
};
  ...
  return function (dictShow1) {
    return function (v) {
      ...
      if (v instanceof Two) {
        return (
          "Two (" +
          (showTree(dictShow)(dictShow1)(v.value0) +
            (") (" +
              (Data_Show.show(dictShow)(v.value1) +
                (") (" +
                  (Data_Show.show(dictShow1)(v.value2) +
                    (") (" +
                      (showTree(dictShow)(dictShow1)(v.value3) + ")")))))))
        );
      }
      if (v instanceof Three) {
        return (
                ...
                (") (" +
                  (Data_Show.show(dictShow1)(v.value2) +
                    (") (" +
                      (showTree(dictShow)(dictShow1)(v.value3) +
                        (") (" +
                          (Data_Show.show(dictShow)(v.value4) +
                            (") (" +
                              (Data_Show.show(dictShow1)(v.value5) +
                                (") (" +
                                  (showTree(dictShow)(dictShow1)(v.value6) +
                                    ")")))))))))))))
        );
      }
      throw new Error(
        "Failed pattern match at Data.Map line 86, column 1 - line 87, column 1: " +
          [v.constructor.name]
      );
    };
  };
  ...
  return function (dictShow1) {
    return new Data_Show.Show(function (m) {
      return (
        "(fromList " +
        (Data_Show.show(
          Data_List.showList(Data_Tuple.showTuple(dictShow)(dictShow1))
        )(toList(m)) +
          ")")
      );
    });
...
var mapWithKey = function (v) {
  return function (v1) {
    ...
    if (v1 instanceof Two) {
      return new Two(
        mapWithKey(v)(v1.value0),
        v1.value1,
        v(v1.value1)(v1.value2),
        mapWithKey(v)(v1.value3)
      );
    }
    if (v1 instanceof Three) {
      return new Three(
        ...
        mapWithKey(v)(v1.value3),
        v1.value4,
        v(v1.value4)(v1.value5),
        mapWithKey(v)(v1.value6)
      );
    }
    throw new Error(
      "Failed pattern match at Data.Map line 417, column 1 - line 417, column 25: " +
  ...
  return function (v) {
    return function (v1) {
      ...
      if (v1 instanceof Two) {
        ...
        throw new Error(
          "Failed pattern match at Data.Map line 153, column 37 - line 156, column 24: " +
      ...
      if (v1 instanceof Three) {
        ...
        if ($137 instanceof Data_Ordering.LT) {
          return Data_Function.apply(lookupLE(dictOrd)(v))(
            new Two(v1.value0, v1.value1, v1.value2, v1.value3)
          );
        }
        throw new Error(
          "Failed pattern match at Data.Map line 157, column 49 - line 160, column 40: " +
            [$137.constructor.name]
        );
      }
      throw new Error(
        "Failed pattern match at Data.Map line 152, column 1 - line 152, column 26: " +
          [v.constructor.name, v1.constructor.name]
      );
    };
  };
  ...
  return function (v) {
    return function (v1) {
      ...
      if (v1 instanceof Two) {
        ...
        throw new Error(
          "Failed pattern match at Data.Map line 177, column 37 - line 180, column 25: " +
            [$147.constructor.name]
        );
      }
      if (v1 instanceof Three) {
        ...
        if ($152 instanceof Data_Ordering.GT) {
          return Data_Function.apply(lookupGE(dictOrd)(v))(
            new Two(v1.value3, v1.value4, v1.value5, v1.value6)
          );
        }
        throw new Error(
          "Failed pattern match at Data.Map line 181, column 49 - line 184, column 41: " +
            [$152.constructor.name]
        );
      }
      throw new Error(
        "Failed pattern match at Data.Map line 176, column 1 - line 176, column 26: " +
          [v.constructor.name, v1.constructor.name]
      );
    };
  };
      ...
      return function (tree) {
        ...
        return __unused(dictPartial)(
          (function () {
            ...
            throw new Error(
              "Failed pattern match at Data.Map line 133, column 10 - line 147, column 39: " +
...
var keys = function (v) {
  ...
  if (v instanceof Two) {
    return Data_Semigroup.append(Data_List.semigroupList)(keys(v.value0))(
      Data_Semigroup.append(Data_List.semigroupList)(
        Control_Applicative.pure(Data_List.applicativeList)(v.value1)
      )(keys(v.value3))
    );
  }
  if (v instanceof Three) {
    return Data_Semigroup.append(Data_List.semigroupList)(keys(v.value0))(
      Data_Semigroup.append(Data_List.semigroupList)(
        ...
        Data_Semigroup.append(Data_List.semigroupList)(keys(v.value3))(
          Data_Semigroup.append(Data_List.semigroupList)(
            Control_Applicative.pure(Data_List.applicativeList)(v.value4)
          )(keys(v.value6))
        )
      )
    );
  ...
  throw new Error(
    "Failed pattern match at Data.Map line 385, column 1 - line 385, column 16: " +
      [v.constructor.name]
  );
};
...
var functorMap = new Data_Functor.Functor(function (v) {
  return function (v1) {
    ...
    if (v1 instanceof Two) {
      return new Two(
        Data_Functor.map(functorMap)(v)(v1.value0),
        v1.value1,
        v(v1.value2),
        Data_Functor.map(functorMap)(v)(v1.value3)
      );
    }
    if (v1 instanceof Three) {
      return new Three(
        ...
        v1.value4,
        v(v1.value5),
        Data_Functor.map(functorMap)(v)(v1.value6)
      );
    }
    throw new Error(
      "Failed pattern match at Data.Map line 71, column 3 - line 71, column 20: " +
        [v.constructor.name, v1.constructor.name]
    );
  };
});
    ...
    return function (__copy_tree) {
      ...
      tco: while (true) {
        ...
        if (v instanceof Data_List.Cons) {
          ...
          throw new Error(
            "Failed pattern match at Data.Map line 224, column 3 - line 229, column 88: " +
              [v.value0.constructor.name]
          );
        }
        throw new Error(
          "Failed pattern match at Data.Map line 222, column 1 - line 222, column 27: " +
  ...
  var up = function (__copy_v) {
    return function (__copy_v1) {
      ...
      tco: while (true) {
        ...
        if (v instanceof Data_List.Cons) {
          if (v.value0 instanceof TwoLeft) {
            return fromZipper(dictOrd)(v.value1)(
              new Three(
                v1.value0,
                v1.value1,
                v1.value2,
          ...
          throw new Error(
            "Failed pattern match at Data.Map line 260, column 5 - line 265, column 104: " +
              [v.value0.constructor.name, v1.constructor.name]
          );
        }
        throw new Error(
          "Failed pattern match at Data.Map line 258, column 3 - line 258, column 54: " +
            [v.constructor.name, v1.constructor.name]
        );
      }
    };
          ...
          tco: while (true) {
            ...
            if (v1 instanceof Two) {
              ...
              if ($290 instanceof Data_Ordering.LT) {
                var __tco_ctx = new Data_List.Cons(
            ...
            if (v1 instanceof Three) {
              ...
              if (
                $295 instanceof Data_Ordering.GT &&
                $297 instanceof Data_Ordering.LT
              ) {
                var __tco_ctx = new Data_List.Cons(
                  new ThreeMiddle(
                    v1.value0,
            ...
            throw new Error(
              "Failed pattern match at Data.Map line 241, column 3 - line 241, column 52: " +
                [
  ...
  var up = Partial_Unsafe.unsafePartial(function (dictPartial) {
    return function (ctxs) {
      return function (tree) {
        ...
        if (ctxs instanceof Data_List.Cons) {
          ...
          return __unused(dictPartial)(
            (function () {
              ...
              throw new Error(
                "Failed pattern match at Data.Map line 310, column 9 - line 327, column 136: " +
        ...
        throw new Error(
          "Failed pattern match at Data.Map line 307, column 5 - line 327, column 136: " +
      ...
      return function (m) {
        ...
        return __unused(dictPartial)(
          (function () {
            ...
            throw new Error(
              "Failed pattern match at Data.Map line 339, column 5 - line 343, column 107: " +
                [m.constructor.name]
            );
          })()
        );
    ...
    return function (m) {
      ...
      return __unused(dictPartial)(
        (function () {
          ...
          throw new Error(
            "Failed pattern match at Data.Map line 330, column 33 - line 334, column 45: " +
              [m.constructor.name]
          );
        })()
      );
      ...
      return function (k) {
        return function (m) {
          ...
          if (m instanceof Three) {
            ...
            if (
              $517 instanceof Data_Ordering.GT &&
              $518 instanceof Data_Ordering.LT
            ) {
              return down(
                new Data_List.Cons(
                  new ThreeMiddle(
          ...
          throw new Error(
            "Failed pattern match at Data.Map line 280, column 36 - line 303, column 82: " +
              [m.constructor.name]
          );
        };
      };
...
var foldableMap = new Data_Foldable.Foldable(
  function (dictMonoid) {
    return function (f) {
      return function (m) {
        return Data_Foldable.foldMap(Data_List.foldableList)(dictMonoid)(f)(
          values(m)
        );
      };
    };
...
var findMin = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Data.Map line 206, column 1 - line 206, column 23: " +
      [v.constructor.name]
  );
};
  ...
  return function (v) {
    return function (v1) {
      ...
      if (v1 instanceof Two) {
        ...
        throw new Error(
          "Failed pattern match at Data.Map line 189, column 37 - line 192, column 25: " +
      ...
      if (v1 instanceof Three) {
        ...
        if ($545 instanceof Data_Ordering.EQ) {
          return Data_Function.apply(findMin)(
            new Two(v1.value3, v1.value4, v1.value5, v1.value6)
          );
        }
        ...
        if ($545 instanceof Data_Ordering.GT) {
          return Data_Function.apply(lookupGT(dictOrd)(v))(
            new Two(v1.value3, v1.value4, v1.value5, v1.value6)
          );
        }
        throw new Error(
          "Failed pattern match at Data.Map line 193, column 49 - line 196, column 41: " +
            [$545.constructor.name]
        );
      }
      throw new Error(
        "Failed pattern match at Data.Map line 188, column 1 - line 188, column 26: " +
          [v.constructor.name, v1.constructor.name]
      );
    };
  };
...
var findMax = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Data.Map line 200, column 1 - line 200, column 23: " +
      [v.constructor.name]
  );
};
  ...
  return function (v) {
    return function (v1) {
      ...
      if (v1 instanceof Two) {
        ...
        throw new Error(
          "Failed pattern match at Data.Map line 165, column 37 - line 168, column 24: " +
      ...
      if (v1 instanceof Three) {
        ...
        if ($572 instanceof Data_Ordering.EQ) {
          return Data_Function.apply(findMax)(
            new Two(v1.value0, v1.value1, v1.value2, v1.value3)
          );
        }
        ...
        if ($572 instanceof Data_Ordering.LT) {
          return Data_Function.apply(lookupLT(dictOrd)(v))(
            new Two(v1.value0, v1.value1, v1.value2, v1.value3)
          );
        }
        throw new Error(
          "Failed pattern match at Data.Map line 169, column 49 - line 172, column 40: " +
            [$572.constructor.name]
        );
      }
      throw new Error(
        "Failed pattern match at Data.Map line 164, column 1 - line 164, column 26: " +
          [v.constructor.name, v1.constructor.name]
      );
    };
  };
...
var eqMap = function (dictEq) {
  return function (dictEq1) {
    return new Data_Eq.Eq(function (m1) {
      return function (m2) {
        return Data_Eq.eq(
          Data_List.eqList(Data_Tuple.eqTuple(dictEq)(dictEq1))
        )(toList(m1))(toList(m2));
      };
    });
  };
...
var ordMap = function (dictOrd) {
  return function (dictOrd1) {
    return new Data_Ord.Ord(
      function () {
        return eqMap(dictOrd["__superclass_Data.Eq.Eq_0"]())(
          dictOrd1["__superclass_Data.Eq.Eq_0"]()
        );
      },
      function (m1) {
        return function (m2) {
          return Data_Ord.compare(
            Data_List.ordList(Data_Tuple.ordTuple(dictOrd)(dictOrd1))
          )(toList(m1))(toList(m2));
        };
      }
    );
  ...
  var allHeights = function (v) {
    ...
    if (v instanceof Two) {
      return Data_Functor.map(Data_List.functorList)(function (n) {
        ...
        Data_Semigroup.append(Data_List.semigroupList)(allHeights(v.value0))(
          allHeights(v.value3)
        )
      );
    }
    if (v instanceof Three) {
      return Data_Functor.map(Data_List.functorList)(function (n) {
        ...
        Data_Semigroup.append(Data_List.semigroupList)(allHeights(v.value0))(
          Data_Semigroup.append(Data_List.semigroupList)(allHeights(v.value3))(
            allHeights(v.value6)
          )
        )
      );
    ...
    throw new Error(
      "Failed pattern match at Data.Map line 121, column 3 - line 121, column 30: " +
        [v.constructor.name]
    );
  };
  ...
  return function (f) {
    return function (k) {
      return function (m) {
        ...
        throw new Error(
          "Failed pattern match at Data.Map line 348, column 15 - line 350, column 25: " +
            [$595.constructor.name]
        );
      };
    };
  };
    ...
    return function (f) {
      var combine = function (v) {
        return function (v1) {
          ...
          throw new Error(
            "Failed pattern match at Data.Map line 365, column 3 - line 365, column 38: " +
              [v.constructor.name, v1.constructor.name]
          );
        };
      };
          ...
          return function (v) {
            return alter(dictOrd)(function ($608) {
              return Data_Maybe.Just.create(
                Data_Maybe.maybe(v.value1)(f(v.value1))($608)
              );
            })(v.value0)(m);
          };
        };
...
var traversableMap = function (dictOrd) {
  return new Data_Traversable.Traversable(
    ...
    function (dictApplicative) {
      return Data_Traversable.traverse(traversableMap(dictOrd))(
        dictApplicative
...
var update = function (dictOrd) {
  return function (f) {
    return function (k) {
      return function (m) {
        return alter(dictOrd)(Data_Maybe.maybe(Data_Maybe.Nothing.value)(f))(k)(
          m
        );
      };
    };
