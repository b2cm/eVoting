...
var showSet = function (dictShow) {
  return new Data_Show.Show(function (s) {
    return (
      "(fromFoldable " +
      (Data_Show.show(Data_List_1.showList(dictShow))(toList(s)) + ")")
    );
  });
};
...
var foldableSet = new Data_Foldable.Foldable(
  function (dictMonoid) {
    return function (f) {
      return function ($60) {
        return Data_Foldable.foldMap(Data_List_1.foldableList)(dictMonoid)(f)(
          toList($60)
        );
      };
    };
...
var eqSet = function (dictEq) {
  return new Data_Eq.Eq(function (v) {
    return function (v1) {
      return Data_Eq.eq(Data_Map.eqMap(dictEq)(Data_Eq.eqUnit))(v.value0)(
        v1.value0
      );
    };
  });
...
var ordSet = function (dictOrd) {
  return new Data_Ord.Ord(
    ...
    function (s1) {
      return function (s2) {
        return Data_Ord.compare(Data_List_1.ordList(dictOrd))(toList(s1))(
          toList(s2)
        );
      };
    }
...
var intersection = function (dictOrd) {
  return function (s1) {
    return function (s2) {
        ...
        var go = Partial_Unsafe.unsafePartial(function (dictPartial) {
          return function (l) {
            return function (r) {
              var $52 = l < ll && r < rl;
              if ($52) {
                var $53 = Data_Ord.compare(dictOrd)(
                  Data_Array_Partial.unsafeIndex(dictPartial)(ls)(l)
                )(Data_Array_Partial.unsafeIndex(dictPartial)(rs)(r));
                if ($53 instanceof Data_Ordering.EQ) {
                  return function __do() {
                    Data_Array_ST.pushSTArray(acc)(
                      Data_Array_Partial.unsafeIndex(dictPartial)(ls)(l)
                    )();
                    return Data_Function.apply(
                      Control_Applicative.pure(Control_Monad_Eff.applicativeEff)
                    )(
                ...
                throw new Error(
                  "Failed pattern match at Data.Set line 160, column 12 - line 165, column 43: " +
                    [$53.constructor.name]
                );
              }
              if (!$52) {
                return Data_Function.apply(
                  Control_Applicative.pure(Control_Monad_Eff.applicativeEff)
                )(new Data_Either.Right(acc));
              }
              throw new Error(
                "Failed pattern match at Data.Set line 159, column 7 - line 166, column 25: " +
                  [$52.constructor.name]
              );
            };
          };
      ...
      return Data_Function.apply(
        fromFoldable(Data_Foldable.foldableArray)(dictOrd)
      )(
...
var difference = function (dictOrd) {
  return function (s1) {
    return function (s2) {
      return Data_Foldable.foldl(Data_List_1.foldableList)(
        Data_Function.flip($$delete(dictOrd))
      )(s1)(toList(s2));
    };
  };
};
  ...
  return function (s1) {
    return function (s2) {
      return (
        ...
        Data_Eq.notEq(eqSet(dictOrd["__superclass_Data.Eq.Eq_0"]()))(s1)(s2)
      );
    };
  };
};
