...
var mMod = function (a) {
  return function (b) {
    ...
    if ($0) {
      return Data_EuclideanRing.mod(Data_BigInt.euclideanRingBigInt)(
        Data_Semiring.add(Data_BigInt.semiringBigInt)(ab)(b)
      )(b);
    }
    if (!$0) {
      return ab;
    ...
    throw new Error(
      "Failed pattern match at Data.Modular line 9, column 12 - line 9, column 56: " +
        [$0.constructor.name]
    );
  };
};
...
var mJoin = function (ints) {
  return Data_String.joinWith("")(
    Data_Functor.map(Data_Functor.functorArray)(Data_BigInt.toBase(16))(ints)
  );
};
  ...
  return function (a) {
    return function (b) {
      if (Data_BigInt.negative(b)) {
        return mInv(p)(
          Data_BigInt.modPow(a)(Data_Ring.negate(Data_BigInt.ringBigInt)(b))(p)
        );
      }
      ...
      throw new Error(
        "Failed pattern match at Data.Modular line 13, column 1 - line 15, column 30: " +
          [p.constructor.name, a.constructor.name, b.constructor.name]
      );
    };
  };
};
