...
var formatSignature = function (v) {
  return (
    Data_BigInt.toBase(16)(v.value0) +
    ("|" +
      (Data_BigInt.toBase(16)(v.value1) +
        ("|" +
          Data_String.joinWith(":")(
            Data_Functor.map(Data_Functor.functorArray)(Data_BigInt.toBase(16))(
              v.value2
            )
          ))))
  );
...
var formatParty = function (v) {
  return (
    Data_BigInt.toBase(16)(v.value0) + ("/" + Data_BigInt.toBase(16)(v.value1))
  );
};
var main = function __do() {
  Control_Monad_Eff_Console.log("\n:: Generating ring with 16 members...")();
  var v = Data_Unfoldable.replicateA(Control_Monad_Eff.applicativeEff)(
    Data_Unfoldable.unfoldableArray
  )(Data_Traversable.traversableArray)(16)(Crypto_LRS_SimpleAPI.gen)();
  var pvts = Data_Functor.map(Data_Functor.functorArray)(Crypto_LRS.privateKey)(
    v
  );
  var pubs = Data_Functor.map(Data_Functor.functorArray)(Crypto_LRS.publicKey)(
    v
  );
  var party = function (n) {
    return Data_Maybe.fromMaybe(
      new Crypto_LRS.Party(Data_BigInt.fromInt(0), Data_BigInt.fromInt(0))
    )(Data_Array.index(v)(n));
  };
  Data_Function.apply(Control_Monad_Eff_Console.log)(
    "\n:: Generated PUB/PVT key pairs: "
  )();
  Data_Function.apply(Control_Monad_Eff_Console.log)(
    Data_Function.apply(Data_String.joinWith("\n"))(
      Data_Functor.map(Data_Functor.functorArray)(function (i) {
        return (
          "MEMBER " +
          (Data_Show.show(Data_Show.showInt)(i) +
            (": " + formatParty(party(i))))
        );
  ...
  Data_Function.apply(Control_Monad_Eff_Console.log)(
    "MSG: 'testMsg0' (from member 0/16); SIG: " + formatSignature(v1)
  )();
  Data_Function.apply(Control_Monad_Eff_Console.log)(
    "MSG: 'testMsg1' (from member 1/16); SIG: " + formatSignature(v2)
  )();
  Data_Function.apply(Control_Monad_Eff_Console.log)(
    "MSG: 'testMsg2' (from member 2/16); SIG: " + formatSignature(v3)
  )();
  Data_Function.apply(Control_Monad_Eff_Console.log)(
    "MSG: 'testMsg3' (from member 0/16); SIG: " + formatSignature(v4)
  )();
      ...
      return function (i) {
        return function (msg) {
          var fn = (function () {
            ...
            if (!conf) {
              return Data_HeytingAlgebra.not(
                Data_HeytingAlgebra.heytingAlgebraBoolean
              );
            }
            throw new Error(
              "Failed pattern match at Test.Main line 52, column 20 - line 52, column 44: " +
          ...
          var verb = (function () {
            ...
            throw new Error(
              "Failed pattern match at Test.Main line 53, column 20 - line 54, column 9: " +
                [conf.constructor.name]
            );
          })();
          return function __do() {
            Data_Function.apply(Test_Assert.assert)(
              fn(Crypto_LRS_SimpleAPI.verify(pubs)(sig)(msg))
            )();
            return Control_Monad_Eff_Console.log(
              "signature " +
                (Data_Show.show(Data_Show.showInt)(i) +
                  (" " + (verb + (" someone signed '" + (msg + "'")))))
            )();
          };
        };
      };
  ...
  Data_Function.apply(Test_Assert.assert)(
    !Crypto_LRS_SimpleAPI.verify(subpubs)(v1)("testMsg0")
  )();
  Data_Function.apply(Test_Assert.assert)(
    !Crypto_LRS_SimpleAPI.verify(subpubs)(v2)("testMsg1")
  )();
  Data_Function.apply(Test_Assert.assert)(
    !Crypto_LRS_SimpleAPI.verify(subpubs)(v3)("testMsg2")
  )();
  Data_Function.apply(Test_Assert.assert)(
    !Crypto_LRS_SimpleAPI.verify(subpubs)(v4)("testMsg3")
  )();
  Control_Monad_Eff_Console.log(
