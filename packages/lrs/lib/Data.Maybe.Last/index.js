...
var semigroupLast = new Data_Semigroup.Semigroup(function (v) {
  return function (v1) {
    ...
    throw new Error(
      "Failed pattern match at Data.Maybe.Last line 67, column 3 - line 67, column 39: " +
...
var invariantLast = new Data_Functor_Invariant.Invariant(
  Data_Functor_Invariant.imapF(functorLast)
);
var extendLast = new Control_Extend.Extend(
  function () {
    return functorLast;
  },
  function (f) {
...
var boundedLast = function (dictBounded) {
  return new Data_Bounded.Bounded(
    ...
    Data_Bounded.bottom(Data_Maybe.boundedMaybe(dictBounded)),
    Data_Bounded.top(Data_Maybe.boundedMaybe(dictBounded))
  );
};
var applyLast = new Control_Apply.Apply(
  function () {
    return functorLast;
  },
  function (v) {
...
var bindLast = new Control_Bind.Bind(
  function () {
    return applyLast;
  },
  function (v) {
...
var applicativeLast = new Control_Applicative.Applicative(
  function () {
    return applyLast;
  },
  function ($36) {
...
var monadLast = new Control_Monad.Monad(
  function () {
