...
var invariantIdentity = new Data_Functor_Invariant.Invariant(
  Data_Functor_Invariant.imapF(functorIdentity)
);
var foldableIdentity = new Data_Foldable.Foldable(
  function (dictMonoid) {
    return function (f) {
      return function (v) {
        return f(v);
...
var traversableIdentity = new Data_Traversable.Traversable(
  function () {
...
var extendIdentity = new Control_Extend.Extend(
  function () {
    return functorIdentity;
  },
  function (f) {
...
var comonadIdentity = new Control_Comonad.Comonad(
  function () {
...
var applyIdentity = new Control_Apply.Apply(
  function () {
    return functorIdentity;
  },
  function (v) {
...
var bindIdentity = new Control_Bind.Bind(
  function () {
...
var monadIdentity = new Control_Monad.Monad(
  function () {
...
var altIdentity = new Control_Alt.Alt(
  function () {
    return functorIdentity;
  },
  function (x) {
