...
var semiringBigInt = new Data_Semiring.Semiring(
  $foreign.biAdd,
  $foreign.biMul,
  $foreign.fromInt(1),
  $foreign.fromInt(0)
...
var fromBase = $foreign["fromBase'"](Data_Maybe.Just.create)(
  Data_Maybe.Nothing.value
);
var fromString = fromBase(10);
var eqBigInt = new Data_Eq.Eq($foreign.biEquals);
var ordBigInt = new Data_Ord.Ord(
  function () {
    return eqBigInt;
  },
  function (x) {
...
var commutativeRingBigInt = new Data_CommutativeRing.CommutativeRing(
  function () {
    return ringBigInt;
  }
);
var euclideanRingBigInt = new Data_EuclideanRing.EuclideanRing(
  function () {
    return commutativeRingBigInt;
  },
  function ($1) {
    return Data_EuclideanRing.degree(Data_EuclideanRing.euclideanRingNumber)(
      $foreign.toNumber($1)
    );
  },
  $foreign.biDiv,
