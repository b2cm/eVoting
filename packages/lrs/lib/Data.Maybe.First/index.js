...
var showFirst = function (dictShow) {
  return new Data_Show.Show(function (v) {
    return (
      "First (" + (Data_Show.show(Data_Maybe.showMaybe(dictShow))(v) + ")")
    );
  });
};
...
var invariantFirst = new Data_Functor_Invariant.Invariant(
  Data_Functor_Invariant.imapF(functorFirst)
);
var extendFirst = new Control_Extend.Extend(
  function () {
    return functorFirst;
  },
  function (f) {
...
var applicativeFirst = new Control_Applicative.Applicative(
  function () {
    return applyFirst;
  },
  function ($36) {
